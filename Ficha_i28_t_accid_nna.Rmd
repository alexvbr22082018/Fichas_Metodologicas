...
***
#### Definición:
La `r params$nombreindicador` es la relación entre el total de defunciones en personas menores de 18 años a causa de accidentes de transporte terrestre por cada 100.000 habitantes en un periodo determinado.
...
$$ TMATnna^t= \frac{\sum_i^n{x_{i}^t}}{NNA^t} * 100.000 $$
...
- $NNA^t$     : Proyección poblacional en el periodo **t** de NNA.
...
# 028 NNA Tasa de accidentes -------------------------------------

f_t_accidentes_nna <- function(tabla,
