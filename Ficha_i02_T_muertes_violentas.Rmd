...
indicador <-  'i02_t_muertes_violentas'
...
***
#### Definición:
La `r params$nombreindicador` es la relación del total de muertes por causas violentas o externas que incluyen Homicidios, Suicidios, Accidentes de Transporte Terrestre, Eventos de Intención no determinada, Otras cuasas de traumatismos accidentales, y otras muertes violentas por cada 100.000 habitantes. 
...
$$ TMV^t= \frac{\sum_i^n{x_{i}^t}}{N^t} * 100.000 $$


- $TMV^t$    : `r params$nombreindicador` en el periodo/año **t**.

- $x_{i}^t$  : Defunción del individuo **i** en el periodo **t** por una muerte violenta.
...
f_t_mor_viol <- function(tabla, 
                         proyecciones=proy_prov, 
                         vars=c(), 
                         varindicad='muerte_violenta'
                         ) {
