...
indicador <-  'i011_n_mort_neonatal'
...
***
#### Definición:
El `r params$nombreindicador` se define como el número de casos de defunciones de neonatos, niña/os menores de un 27 de días de edad en un periodo determinado. 
