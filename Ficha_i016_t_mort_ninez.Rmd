...
***
#### Definición:
La `r params$nombreindicador` es el número de defunciones de niña/os menores de 12 años de edad, por cada mil nacidos vivos en un periodo determinado. 
...
$$ TMNN^t = \frac{\sum_i^n{d_{i<=12}^t}}{NV^t} * K $$

- $TMNN^t$    : `r params$nombreindicador` en el periodo **t**.

- $d_{i<12}^t$: Defunción del/a niña/o **i** menor de 12 años de edad en el periodo **t**.

- $i$        :  Niña/o **i**.

- $NV^t$     : Nacimientos Vivos en el periodo **t**.
