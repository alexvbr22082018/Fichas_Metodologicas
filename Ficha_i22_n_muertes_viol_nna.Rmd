...
indicador <-  'i22_n_muertes_viol_nna'
...
***
#### Definición:
El `r params$nombreindicador` o muertes por causas externas en NNA son aquellas muertes que incluyen Homicidios, Suicidios, Accidentes de Transporte Terrestre, Eventos de Intención no determinada, Otras cuasas de traumatismos accidentales, y otras muertes violentas en personas menores de 18 años. 
...
$$ NMVnna^t= \sum_{j}^{k} \sum_i^n{x_{i,j}^t} $$

- $NMVnna^t$    : `r params$nombreindicador` en el periodo/ano **t**.

- $x_{i,j}^t$: Defunción del individuo la niña/o o adolescente **i** por el tipo de muerte violenta **j** en el periodo **t**.
...
fc_nna <- function(data,
  ...
  #varindic: variables creadas con la funcion fc_muerte_violenta y fc_nna
