...
***
#### Definición:
El `r params$nombreindicador` corresponde al total de defunciones en personas menores de 18 años (NNA) a causa de suicidios en un periodo determinado.
...
$$ MSnna^t= \sum_i^n{x_{i}^t} $$
  


- $MS^t$    : `r params$nombreindicador` en el periodo/año **t**.
...
```{r echo=T}
  ...
  #varindicad: variable del indicador creada con la funcion fc_suicidios
  
# 027 NNA Numero de suicidios ------------------------------------------------


f_n_suicidios_nna <- function(tabla,
