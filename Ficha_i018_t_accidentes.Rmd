...
***
#### Definición:
La `r params$nombreindicador` es la relación entre el total de defunciones por accidentes de transporte terrestre por cada 100.000 habitantes en un periodo determinado.
...
$$ TMAT^t= \frac{\sum_i^n{x_{i}^t}}{N^t} * 100.000 $$
