...
***
#### Definición:
La `r params$nombreindicador` es el número de defunciones de muertes infantiles (niños y niñas menores de un año de edad) por cada mil nacidos vivos en un periodo $t$. 
