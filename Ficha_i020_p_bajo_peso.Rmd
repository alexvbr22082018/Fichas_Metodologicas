...
***
#### Definición:
El `r params$nombreindicador` corresponde al porcentaje de nacidos vivos con bajo peso al nacer como relación del total de nacidos vivos.
...
$$ PNVBPN^t= \frac{\sum_i^n{x_{i: p<2500}^t}}{TNV^t} $$



- $PNVBPN^t$    : `r params$nombreindicador` en el periodo/año **t**.

- $x_{i}^t$  : Nacido Vivo**i** en el periodo **t** cuyo peso al nacer en gramos es inferior que 2,500.

- $TNV^t$    : Total de Nacidos Vivos en el periodo **t**.
...
```{r echo=T}
  ...
  #proyecciones   : proyecciones de nacidos vivos
  #varindicad: variable del indicador creada con la funcion fc_bpn
  

f_p_bpn <- function(tabla,
