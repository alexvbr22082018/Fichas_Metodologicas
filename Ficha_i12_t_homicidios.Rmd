...
***
#### Definición:
La `r params$nombreindicador` es la relación del total de muertes por Homicidios por cada 100.000 habitantes.
...
$$ TMH^t= \frac{\sum_i^n{x_{i}^t}}{N^t} * 100.000 $$
