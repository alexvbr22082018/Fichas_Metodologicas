...
***
#### Definición:
El `r params$nombreindicador` corresponde al total de defunciones a causa de suicidios en un periodo determinado.
...
- $i$        : Defunción por suicidio del individuo **i**.
