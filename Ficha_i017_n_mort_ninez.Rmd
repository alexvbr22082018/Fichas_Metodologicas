...
***
#### Definición:
El `r params$nombreindicador` se define como el número de casos de defunciones de niña/os menores de 12 años de edad en un periodo determinado. 
