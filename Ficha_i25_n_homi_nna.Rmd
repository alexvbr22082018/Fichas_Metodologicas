...
***
#### Definición:
La `r params$nombreindicador` es el total de muertes de personas menores de 18 años por Homicidios.
...
f_n_homicidios_nna <- function(tabla,
