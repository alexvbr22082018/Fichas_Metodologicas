...
***
#### Definición:
La `r params$nombreindicador` es la relación del total de muertes por suicidios por cada 100.000 habitantes.
...
$$ TMS^t= \frac{\sum_i^n{x_{i}^t}}{N^t} * 100.000 $$


- $TMS^t$    : `r params$nombreindicador` en el periodo/año **t**.

- $x_{i}^t$  : Defunción del individuo **i** en el periodo **t** por a causa de suicidio

- $i$        : Defunción por suicidio individuo **i**.
